...
wire [31:0] wb_dat_i_le = wb_dat_i; 
wire [3:0]  wb_sel_i_le = wb_sel_i;

//Deshabilitamos la inversion de datos en tx
...
wire [31:0] txb_wbdat;
wire [31:0] DOB_txb_dat; 
assign txb_dat = DOB_txb_dat[7:0];
...
assign wb_dat_o = wb_dat_o_le;

//Deshabilitamos la inversion de datos en rx

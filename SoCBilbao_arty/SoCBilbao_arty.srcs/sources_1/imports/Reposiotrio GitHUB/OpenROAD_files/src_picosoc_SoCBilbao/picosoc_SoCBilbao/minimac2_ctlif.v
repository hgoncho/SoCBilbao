...
module minimac2_ctlif #(
    ...
    output mii_data_oe,
    output mii_data_do,
    input  mii_data_di_raw,   // viene del p2c del pad, ya sin sincronizar
    output phy_rst_n
);

reg mii_data_oe;
reg mii_data_do;
//assign phy_mii_data = mii_data_oe ? mii_data_do : 1'bz;       modificacion asic

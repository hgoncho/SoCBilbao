...
// ------------------------------------------------------ 
`celldefine
// RM_IHPSG13_2P_512x32_c2_bm_bist_bb.v
// Vista de caja negra SOLO para síntesis (Yosys/ORFS). No usar en simulación;
// para simulación se usa RM_IHPSG13_2P_512x32_c2_bm_bist.v (el modelo real),
// listado en IHP_MODELS del Makefile.
(* blackbox *)
